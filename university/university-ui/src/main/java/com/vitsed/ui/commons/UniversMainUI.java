...
import com.vitsed.navigator.UniversNavigator;
import com.vitsed.ui.students.StudentLayoutFactory;
...
public class UniversMainUI extends UI {
	...
	@Autowired
	private UniversMenuFactory universMenuFractory;
	...
	protected void init(VaadinRequest request) {
		...
		Component menu = universMenuFractory.createComponent();
